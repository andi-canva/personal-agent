...
## Additional podcast transcripts

The `podcasts/` folder also includes transcripts from [Claire Vo's ChatPRD repo](https://github.com/ChatPRD/lennys-podcast-transcripts), which contains community-contributed transcripts for episodes not yet in the official archive.
